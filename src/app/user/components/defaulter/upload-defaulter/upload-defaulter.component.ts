...
@Component({
  selector: "app-upload-defaulter",
  templateUrl: "./upload-defaulter.component.html",
  styleUrls: ["./upload-defaulter.component.css"]
})
export class UploadDefaulterComponent implements OnInit {
  constructor(
  ...
  //   this.removeError()
  //   if (req_process_type == 'Edit') {

  //     this.customerData.customer_id = this.customerData.customer_id
  //   } else {

  //     this.customerData.customer_id = this.customerData.id
  //   }
  //   this.customerData.submitted_by = this.localStorageService.userDetails.id
  //   this.customerData.status = StatusEnum.Pending
  //   let dueDate = '';
  //   if (this.request_id != '') { // if request is pending or upload document
  //     if (this.customerData.status == 'pending') {
  //       this.customerData.payment_due_date = this.customerData.payment_due_date.year + "/" + this.customerData.payment_due_date.month + "/" + this.customerData.payment_due_date.day
  //     } else {
  //       this.customerData.payment_due_date = this.customerData.temp_payment_due_date.year + "/" + this.customerData.temp_payment_due_date.month + "/" + this.customerData.temp_payment_due_date.day
  //     }
  //     if (this.customerData.status != 'pending') {
  //       dueDate = (this.customerData.temp_payment_due_date.day < 10 ? ('0' + this.customerData.temp_payment_due_date.day) : this.customerData.temp_payment_due_date.day) + "/"
  //         + (this.customerData.temp_payment_due_date.month < 10 ? ('0' + this.customerData.temp_payment_due_date.month) : this.customerData.temp_payment_due_date.month)
  //         + "/" + this.customerData.temp_payment_due_date.year;
  //     } else {
  //       let paymentDueDateSplit = this.customerData.payment_due_date.split("/"); //2019/10/9
  //       this.customerData.temp_payment_due_date = { "year": paymentDueDateSplit[0], "month": paymentDueDateSplit[1], "day": paymentDueDateSplit[2] };
  //       dueDate = (this.customerData.temp_payment_due_date.day < 10 ? ('0' + this.customerData.temp_payment_due_date.day) : this.customerData.temp_payment_due_date.day) + "/"
  //         + (this.customerData.temp_payment_due_date.month < 10 ? ('0' + this.customerData.temp_payment_due_date.month) : this.customerData.temp_payment_due_date.month)
  //         + "/" + this.customerData.temp_payment_due_date.year;
  //     }
  //   } else { // upload defaulter
  //     dueDate = (this.customerData.temp_payment_due_date.day < 10 ? ('0' + this.customerData.temp_payment_due_date.day) : this.customerData.temp_payment_due_date.day) + "/"
  //       + (this.customerData.temp_payment_due_date.month < 10 ? ('0' + this.customerData.temp_payment_due_date.month) : this.customerData.temp_payment_due_date.month)
  //       + "/" + this.customerData.temp_payment_due_date.year;
  //   }
  //   if (this.customerData.gst_no == "" || this.customerData.gst_no == null || this.customerData.gst_no == 0) {

  //     this.errorHandlerService.errorMessage('GST number cannot be blank.');
  //   } else if (this.customerData.email == "" || this.customerData.email == null || this.customerData.email == 0) {
  //     this.errorHandlerService.errorMessage('Email cannot be blank.');
  //   } else if (this.customerData.mobile == "" || this.customerData.mobile == null || this.customerData.mobile == 0) {
  //     this.errorHandlerService.errorMessage('Mobile number cannot be blank.');
  ...
  //   } else if (this.customerData.payment_due_amount == "" || this.customerData.payment_due_amount == null || this.customerData.payment_due_amount == 0) {
  ...
  //   } else if (parseFloat(this.customerData.payment_due_amount) < 10000) {
  //     //this.errorHandlerService.errorMessage('Due amount cannot be less then Rs. 10000/-.');
  //     this.addDefaulterDueAmountError = "Due amount cannot be less then Rs. 10000/-";
  //   } else if (this.customerData.temp_payment_due_date == "" || this.customerData.temp_payment_due_date == null && this.customerData.status != 'pending' && this.request_id != '') {
  //     //this.errorHandlerService.errorMessage('Payment due date cannot be blank.');
  //     this.addDefaulterDueDateError = "Payment due date cannot be blank.";
  //   } else if (this.customerData.payment_due_date == "" || this.customerData.payment_due_date == null && this.customerData.status == 'pending' && this.request_id != '') {
  //     //this.errorHandlerService.errorMessage('Payment due date cannot be blank.');
  //     this.addDefaulterDueDateError = "Payment due date cannot be blank.";
  //   } else if (this.customerData.temp_payment_due_date == "" || this.customerData.temp_payment_due_date == null && this.request_id == '') {
  //     //this.errorHandlerService.errorMessage('Payment due date cannot be blank.');
  //     this.addDefaulterDueDateError = "Payment due date cannot be blank.";
  //   } else if (!this.dateFormatService.checkDateGreater(dueDate, this.dateFormatService.getCurrentDate())) {
  //     this.addDefaulterDueDateError = "Payment due date cannot be today or future date.";
  //     //this.errorHandlerService.errorMessage('Payment due date cannot be today or future date.');
  //   } else if (this.ledgerFileName == '' || this.ledgerFileName == 'Upload Ledger') {
  //     //this.errorHandlerService.errorMessage('Please upload Ledger.');
  //     this.addDefaulterLedgerFileError = "Please upload Ledger.";
  //   } else if (this.caFileName == '' || this.caFileName == 'Upload CA Certificate') {
  ...
  //   } else {
  //     this.confirmationDialogService.confirm('Please confirm', 'Are you sure you want to process?')
  //       .then((confirmed) => {
  //         if (confirmed) {
  //           this.customerData.legal_case = this.customerData.legal_case ? 'yes' : 'no';
  //           this.defaulterService.saveRequest(this.customerData).pipe().subscribe((result) => {
  ...
  //               this.userService.uploadProfilePic(formData).pipe().subscribe((result) => {
  //               }, error => {
  //                 //this.errorHandlerService.handleError(error)
  //               })
  //             }
  ...
  //               this.userService.uploadProfilePic(ledgerFormData).pipe().subscribe((result) => {
  //               }, error => {
  //                 //this.errorHandlerService.handleError(error)
  //               })
  //             }
  ...
  //               this.userService.uploadProfilePic(otherFormData).pipe().subscribe((result) => {
  //               }, error => {
  //                 //this.errorHandlerService.handleError(error)
  //               })
  //             }

  //             this.errorHandlerService.successMessage('Defaulter Request successfully submitted.');
  ...
  //         + "/" + this.customerData.temp_payment_due_date.year;
  //     } else {
  //       dueDate = (this.customerData.payment_due_date.day < 10 ? ('0' + this.customerData.payment_due_date.day) : this.customerData.payment_due_date.day) + "/"
  //         + (this.customerData.payment_due_date.month < 10 ? ('0' + this.customerData.payment_due_date.month) : this.customerData.payment_due_date.month)
  //         + "/" + this.customerData.payment_due_date.year;
  //     }
  //   } else { // upload defaulter
  //     dueDate = (this.customerData.temp_payment_due_date.day < 10 ? ('0' + this.customerData.temp_payment_due_date.day) : this.customerData.temp_payment_due_date.day) + "/"
  //       + (this.customerData.temp_payment_due_date.month < 10 ? ('0' + this.customerData.temp_payment_due_date.month) : this.customerData.temp_payment_due_date.month)
  ...
  //         if (confirmed) {
  //           this.customerData.legal_case = this.customerData.legal_case ? 'yes' : 'no';
  //           if (this.customerData.temp_payment_due_date == undefined || this.customerData.temp_payment_due_date == 'undefined') {
  //             this.customerData.temp_payment_due_date = dueDate;
  //           }
  //           if (this.customerData.payment_due_date == undefined || this.customerData.payment_due_date == 'undefined') {
  //             this.customerData.payment_due_date = dueDate;
  //           }
  //           let paymentDueDateSplit = dueDate.split("/"); //2019/10/9
  //           this.customerData.payment_due_date = paymentDueDateSplit[2] + "-" + paymentDueDateSplit[1] + "-" + paymentDueDateSplit[0];
  //           this.defaulterService.saveRequest(this.customerData).pipe().subscribe((result) => {
  //             //Upload CA certificate
  //             if (this.caFile != null) {
  //               let formData = new FormData();
  ...
  save(req_process_type) {
    ...
    let dueDate = "";
    if (this.request_id != "") {
      // if request is pending or upload document
      if (StatusEnum.Pending != "pending") {
        dueDate =
        ...
        dueDate =
          (this.customerData.payment_due_date.day < 10
            ? "0" + this.customerData.payment_due_date.day
            : this.customerData.payment_due_date.day) +
          "/" +
          (this.customerData.payment_due_date.month < 10
            ? "0" + this.customerData.payment_due_date.month
            : this.customerData.payment_due_date.month) +
          "/" +
          this.customerData.payment_due_date.year;
      }
    } else {
    ...
    if (
      ...
      this.customerData.payment_due_date == "" ||
      (this.customerData.payment_due_date == null &&
        StatusEnum.Pending == "pending" &&
        this.request_id != "")
    ) {
      //this.errorHandlerService.errorMessage('Payment due date cannot be blank.');
      ...
      this.customerData.temp_payment_due_date == "" ||
      (this.customerData.temp_payment_due_date == null && this.request_id == "")
    ) {
      //this.errorHandlerService.errorMessage('Payment due date cannot be blank.');
      this.addDefaulterDueDateError = "Payment due date cannot be blank.";
    } /*else if (
      !this.dateFormatService.checkDateGreater(
        dueDate,
        this.dateFormatService.getCurrentDate()
      )
    ) {
      this.addDefaulterDueDateError =
        "Payment due date cannot be today or future date.";
      //this.errorHandlerService.errorMessage('Payment due date cannot be today or future date.');
    }*/ else if (
      this.ledgerFileName == "" ||
      ...
      this.customerData.legal_case == null ||
      this.customerData.legal_case == ""
    ) {
      this.selectLegalCaseError = "Please select legal case in court status.";
    }  */ else {
      this.confirmationDialogService
        ...
        .then(confirmed => {
          if (confirmed) {
            if (req_process_type == "Edit") {
              this.defaulterService
                .checkStatus({ defaulter_id: this.customerData.id })
                .pipe()
                .subscribe(result => {
                  if (
