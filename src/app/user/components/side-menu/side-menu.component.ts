...
export class SideMenuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function(){
      ...
      $(".jq_overlay_sidebar").click(function(){
        $(".jq_sidebar_menu").toggleClass("mobile-inner-header-icon-click mobile-inner-header-icon-out");
  ...
  loadScoreGraph() {
    this.zone.runOutsideAngular(() => {
      ...
      range4.endValue = (labelValue * 5) == this.maxCQEScore ? (labelValue * 5) : this.maxCQEScore;
