...
export const environment = {
  production: false,
  services: {
    gatewayUrl: "http://192.168.1.120:3003/api/v1/",
    //gatewayUrl: "https://creditq.in/api/api/v1/",
    files: {
      baseUrl: "http://192.168.1.3/creditq/",
    ...
    authorization: {
      ...
      api: {
        postLogin: "/login",
        postCUSTLogin: "/login_by_cust_id"
      }
    },
    ...
    master: {
      ...
      api: {
        ...
        getSetting: "/setting",
        getSupportQuestion: "/support_questions",
        saveSupportQuestion: "/save_support_request"
      }
    }
  },
